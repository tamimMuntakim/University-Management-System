...
// import DepartmentRadar from '../Components/charts/DepartmentRadar';
// import CapacityGauges from '../Components/charts/CapacityGauges';
// import {
//     HiOutlineUsers,
//     HiOutlineAcademicCap,
//     HiOutlineOfficeBuilding,
...
//                         <HiOutlineLightningBolt className="text-primary" /> Peak Login Hours
//                     </h4>
//                     <PolarClock data={data?.loginsByHour || {}} color="#3b82f6" height={300} />
//                 </div>
//                 <div className="card bg-base-100 border border-base-300 rounded-2xl shadow-sm p-6">
//                     <h4 className="font-bold mb-5 flex items-center gap-2 text-base-content/80">
//                         <HiOutlineUsers className="text-secondary" /> User Registration Trend
//                     </h4>
//                     <CalendarHeatmap data={data?.registrationsByDate || {}} color="#10b981" />
//                 </div>
//                 <div className="card bg-base-100 border border-base-300 rounded-2xl shadow-sm p-6">
//                     <h4 className="font-bold mb-5 flex items-center gap-2 text-base-content/80">
//                         <HiOutlineCalendar className="text-accent" /> Faculty Hiring by Year
...
//                 <div className="card bg-base-100 border border-base-300 rounded-2xl shadow-sm p-6">
//                     <h4 className="font-bold mb-5 flex items-center gap-2 text-base-content/80">
//                         <HiOutlineChartBar className="text-info" /> Department Performance Radar
//                     </h4>
//                     <DepartmentRadar
//                         series={[
//                             { label: 'Avg CGPA',   values: data?.averageCgpaByDepartment || {},     max: 4, color: '#8b5cf6' },
//                             { label: 'Avg Rating', values: data?.avgFacultyRatingByDepartment || {}, max: 5, color: '#f59e0b' },
//                         ]}
//                         height={320}
//                     />
//                 </div>
...
//                         <span className="ml-auto text-[10px] font-black text-base-content/30 uppercase">% filled</span>
//                     </h4>
//                     <CapacityGauges data={data?.courseCapacityUtilization || {}} />
//                 </div>
//                 <div className="card bg-base-100 border border-base-300 rounded-2xl shadow-sm p-6">
//                     <h4 className="font-bold mb-5 flex items-center gap-2 text-base-content/80">
//                         <HiOutlineCheckCircle className="text-success" /> Enrollment Status Breakdown
    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="card bg-base-100 border border-base-300 rounded-2xl shadow-sm p-6 lg:col-span-2">
                    <h4 className="font-bold mb-5 flex items-center gap-2 text-base-content/80">
                        <HiOutlineLightningBolt className="text-primary" /> Login Activity by Weekday
                        <span className="ml-auto text-[10px] font-black text-base-content/30 uppercase tracking-widest">hour × day</span>
                    </h4>
                    <WeekdayHeatmap data={data?.loginsByWeekdayHour || {}} color="#3b82f6" />
                </div>
                <div className="card bg-base-100 border border-base-300 rounded-2xl shadow-sm p-6">
                    <h4 className="font-bold mb-5 flex items-center gap-2 text-base-content/80">
                        <HiOutlineCalendar className="text-accent" /> Faculty Hiring by Year
