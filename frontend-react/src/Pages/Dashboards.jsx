...
export const AdminDashboard = () => {
    ...
    if (loading) return <PageLoader message="Loading administrative infrastructure..." />;

    // Derive "Others" = users who are neither students nor faculty (e.g. standalone admin accounts)
    const othersCount = Math.max(0, stats.totalUsers - stats.totalStudents - stats.totalFaculty);
        ...
        <div className="space-y-10 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-base-content/80 font-medium mt-1 uppercase tracking-[0.2em] text-[10px]">
                        Infrastructure & Resource Management
                    </p>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-base-100 rounded-2xl border border-base-300 shadow-md">
                    <div className="w-2 h-2 rounded-full bg-success animate-pulse" />
                    <span className="text-[10px] font-black uppercase tracking-widest text-base-content/90">
                        System Operational
                    </span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="relative group overflow-hidden bg-base-100 border border-base-300 rounded-[2.5rem] p-8 shadow-lg transition-all hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/20 hover:-translate-y-1">
                    ...
                    <div className="text-[10px] font-bold text-base-content/90 uppercase">User Database</div>
                </div>
            ...
            {/* ── D3 System Composition ─────────────────────────────────── */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-1 bg-base-100 border border-base-300 rounded-[3rem] p-8 shadow-xl flex flex-col items-center relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-primary via-secondary to-accent rounded-t-[3rem]" />
                    <div className="mb-6 text-center">
                        <h4 className="text-lg font-black text-base-content tracking-tighter">System Composition</h4>
                        <p className="text-[10px] font-bold text-base-content/50 uppercase tracking-widest mt-0.5">
                            User Distribution
                        </p>
                    </div>
                    <DonutChart data={compositionData} maxSize={200} />
                </div>
                ...
                <div className="lg:col-span-2 bg-base-100 border border-base-300 rounded-[3rem] p-10 shadow-xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <NavLink
                            to="/admin/analytics"
                            className="btn btn-sm btn-ghost bg-primary/5 hover:bg-primary/10 border-none text-[10px] font-black uppercase tracking-widest rounded-xl transition-all"
                        >
                            Full Analytics
                        </NavLink>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                        <NavLink to="/admin/users"
                            className="p-6 rounded-[2rem] bg-base-200/50 hover:bg-base-100 hover:shadow-2xl hover:shadow-primary/10 transition-all border border-base-300/50 flex items-center gap-6 group/item active:scale-95">
                            <div className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center text-primary group-hover/item:scale-110 transition-transform">
                                <HiOutlineUsers size={28} />
                            </div>
                            <div>
                        ...
                        <NavLink to="/admin/departments"
                            className="p-6 rounded-[2rem] bg-base-200/50 hover:bg-base-100 hover:shadow-2xl hover:shadow-secondary/10 transition-all border border-base-300/50 flex items-center gap-6 group/item active:scale-95">
                            <div className="w-14 h-14 rounded-2xl bg-secondary/10 flex items-center justify-center text-secondary group-hover/item:scale-110 transition-transform">
                                <HiOutlineOfficeBuilding size={28} />
                            </div>
                            <div>
            ...
            {/* Promo card */}
            <div className="bg-primary rounded-[3rem] p-10 text-primary-content shadow-2xl shadow-primary/20 flex flex-col md:flex-row md:items-center justify-between gap-8 relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-40 h-40 bg-white/10 rounded-full -mr-20 -mt-20 transition-transform group-hover:scale-125" />
                <div>
                    <HiOutlineSparkles size={40} className="mb-4 opacity-50" />
                    <h4 className="text-2xl font-black leading-tight italic">Empowering<br />Academic Excellence</h4>
                    <p className="text-primary-content/70 text-sm mt-3 font-medium leading-relaxed max-w-md">
                        Manage institution infrastructure with real-time intelligence and precision.
                    </p>
                </div>
                <button className="btn btn-ghost bg-white/10 hover:bg-white/20 border-none text-[10px] font-black uppercase tracking-widest rounded-2xl text-white shrink-0 px-8">
                    System Configuration
                </button>
            </div>
        </div>
...
export const FacultyDashboard = () => {
    ...
    if (loading) return <PageLoader message="Organizing academic materials..." />;
    ...
    return (
        <div className="space-y-10 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="relative group overflow-hidden bg-base-100 border border-base-300 rounded-[2.5rem] p-10 shadow-lg transition-all hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/20 hover:-translate-y-1">
                    <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-all group-hover:scale-110">
                        <HiOutlineClipboardList size={80} className="text-primary" />
                    </div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-base-content/70 mb-1">Courses Assigned</p>
                    <h3 className="text-5xl font-black text-primary tracking-tighter mb-2 group-hover:scale-105 transition-transform origin-left">
                        {stats.totalCourses}
                    </h3>
                    <div className="text-[10px] font-bold text-base-content/80 uppercase tracking-widest">Active Sections</div>
                </div>
                ...
                <div className="relative group overflow-hidden bg-base-100 border border-base-300 rounded-[2.5rem] p-10 shadow-lg transition-all hover:border-secondary/50 hover:shadow-2xl hover:shadow-secondary/20 hover:-translate-y-1">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest text-base-content/70 mb-1">Total Students</p>
                    <h3 className="text-5xl font-black text-secondary tracking-tighter mb-2 group-hover:scale-105 transition-transform origin-left">
                        {stats.totalStudents}
                    </h3>
                    <div className="text-[10px] font-bold text-base-content/80 uppercase tracking-widest">Under Your Instruction</div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 bg-base-100 border border-base-300 rounded-[3rem] p-10 shadow-xl relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-primary via-secondary to-accent" />
                    <h4 className="text-2xl font-black text-base-content tracking-tighter mb-2">Faculty Profile</h4>
                    <p className="text-xs font-medium text-base-content/70 uppercase tracking-widest mb-8">Academic Details</p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-base-200/50 p-6 rounded-[2rem] border border-base-300/50 hover:bg-base-200 transition-all shadow-sm">
                            <span className="text-[10px] font-black text-base-content/50 uppercase tracking-[0.3em] block mb-2">Designation</span>
                            <p className="text-xl font-black text-primary tracking-tight">{stats.designation}</p>
                        </div>
                        <div className="bg-base-200/50 p-6 rounded-[2rem] border border-base-300/50 hover:bg-base-200 transition-all shadow-sm">
                            <span className="text-[10px] font-black text-base-content/50 uppercase tracking-[0.3em] block mb-2">Department</span>
                        ...
                        <div className="bg-base-200/50 p-6 rounded-[2rem] border border-base-300/50 flex items-center justify-between hover:bg-base-200 transition-all shadow-sm">
                            <div>
                                <span className="text-[10px] font-black text-base-content/60 uppercase tracking-[0.3em] block mb-1">Status</span>
                                <span className="badge badge-success badge-sm font-black px-3 py-2 rounded-full uppercase tracking-tighter">Verified</span>
                            </div>
                ...
                <div className="bg-neutral rounded-[3rem] p-10 text-neutral-content shadow-2xl shadow-neutral/30 transition-all hover:-translate-y-1 relative overflow-hidden group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <NavLink to="/faculty/courses"
                    className="p-6 rounded-[2rem] bg-base-100 border border-base-300/50 shadow-md hover:border-primary/30 hover:shadow-2xl hover:shadow-primary/10 transition-all flex items-center gap-6 group">
                    <div className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center text-primary group-hover:rotate-12 transition-transform">
                        <HiOutlineClipboardList size={28} />
                    </div>
                    <div>
                ...
                <NavLink to="/faculty/profile"
                    className="p-6 rounded-[2rem] bg-base-100 border border-base-300/50 shadow-md hover:border-secondary/30 hover:shadow-2xl hover:shadow-secondary/10 transition-all flex items-center gap-6 group">
                    <div className="w-14 h-14 rounded-2xl bg-secondary/10 flex items-center justify-center text-secondary group-hover:rotate-12 transition-transform">
                        <HiOutlineUserCircle size={28} />
                    </div>
                    <div>
...
export const StudentDashboard = () => {
    ...
    if (loading) return <PageLoader message="Generating academic transcript summary..." />;
        ...
        <div className="space-y-10 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="relative group overflow-hidden bg-base-100 border border-base-300 rounded-[2.5rem] p-8 shadow-lg transition-all hover:border-secondary/50 hover:shadow-2xl hover:shadow-secondary/20 hover:-translate-y-1">
                    ...
                    <div className="flex items-center gap-2 text-secondary font-black text-[10px] uppercase tracking-wider">
                        <span className="w-4 h-[2px] bg-secondary/30" /> Progression Path
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-base-100 border border-base-300 rounded-[3rem] p-10 shadow-xl relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-6">
                            <div className="bg-base-200/50 p-6 rounded-[2rem] border border-base-300/50 hover:bg-base-200 shadow-sm transition-all">
                                <span className="text-[10px] font-black text-base-content/50 uppercase tracking-[0.3em] block mb-2">University ID</span>
                                <p className="text-2xl font-black text-primary tracking-tighter">{stats.regId}</p>
                            </div>
                            <div className="bg-base-200/50 p-6 rounded-[2rem] border border-base-300/50 hover:bg-base-200 shadow-sm transition-all">
