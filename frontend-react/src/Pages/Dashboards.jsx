        ...
        <div className="space-y-10 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-base-content/50 font-medium mt-1 uppercase tracking-[0.2em] text-[10px]">Infrastructure & Resource Management</p>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-base-100 rounded-2xl border border-base-300 shadow-sm">
                    <div className="w-2 h-2 rounded-full bg-success animate-pulse"></div>
                    <span className="text-[10px] font-black uppercase tracking-widest text-base-content/60">System Operational</span>
                </div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {/* Total Users */}
                <div className="relative group overflow-hidden bg-base-100 border border-base-300 rounded-[2.5rem] p-8 transition-all hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/10">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest text-base-content/40 mb-1">Authenticated Accounts</p>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-bold text-base-content/60 uppercase">User Database</span>
                    </div>
                </div>

                {/* Total Students */}
                <div className="relative group overflow-hidden bg-base-100 border border-base-300 rounded-[2.5rem] p-8 transition-all hover:border-secondary/50 hover:shadow-2xl hover:shadow-secondary/10">
                    <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-20 transition-all group-hover:scale-110">
                        <HiOutlineUserGroup size={80} className="text-secondary" />
                    </div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-base-content/40 mb-1">Student Body</p>
                    ...
                    <div className="text-[10px] font-bold text-base-content/40 uppercase tracking-widest">Enrolled Learners</div>
                </div>

                {/* Total Faculty */}
                <div className="relative group overflow-hidden bg-base-100 border border-base-300 rounded-[2.5rem] p-8 transition-all hover:border-accent/50 hover:shadow-2xl hover:shadow-accent/10">
                    <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-20 transition-all group-hover:scale-110">
                        <HiOutlineAcademicCap size={80} className="text-accent" />
                    </div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-base-content/40 mb-1">Academic Staff</p>
                    ...
                    <div className="text-[10px] font-bold text-base-content/40 uppercase tracking-widest">Educators & Mentors</div>
                </div>

                {/* Departments */}
                <div className="relative group overflow-hidden bg-base-100 border border-base-300 rounded-[2.5rem] p-8 transition-all hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-500/10">
                    <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-20 transition-all group-hover:scale-110">
                        <HiOutlineOfficeBuilding size={80} className="text-purple-600" />
                    </div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-base-content/40 mb-1">Organization</p>
                    ...
                    <div className="text-[10px] font-bold text-base-content/40 uppercase tracking-widest">Academic Units</div>
                </div>

                {/* Course Catalog */}
                <div className="relative group overflow-hidden bg-base-100 border border-base-300 rounded-[2.5rem] p-8 transition-all hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-500/10">
                    <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-20 transition-all group-hover:scale-110">
                        <HiOutlineBookOpen size={80} className="text-blue-600" />
                    </div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-base-content/40 mb-1">Curriculum</p>
                    ...
                    <div className="text-[10px] font-bold text-base-content/40 uppercase tracking-widest">Courses in Catalog</div>
                </div>

                {/* Active Offerings */}
                <div className="relative group overflow-hidden bg-base-100 border border-base-300 rounded-[2.5rem] p-8 transition-all hover:border-amber-500/50 hover:shadow-2xl hover:shadow-amber-500/10">
                    <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-20 transition-all group-hover:scale-110">
                        <HiOutlineSparkles size={80} className="text-amber-600" />
                    </div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-base-content/40 mb-1">Operations</p>
                    ...
                    <div className="text-[10px] font-bold text-base-content/40 uppercase tracking-widest">Active Offerings</div>
                </div>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Main System Card */}
                <div className="lg:col-span-2 bg-base-100 border border-base-300 rounded-[3rem] p-10 relative overflow-hidden group">
                    ...
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p className="text-xs font-medium text-base-content/40 uppercase tracking-widest">Core System Modules</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                        <NavLink to="/admin/users" className="p-6 rounded-[2rem] bg-base-200/50 hover:bg-white hover:shadow-xl hover:shadow-primary/5 transition-all border border-base-300/50 flex items-center gap-6 group/item active:scale-95">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-base-content/40 font-bold uppercase tracking-widest">User Directory</p>
                            </div>
                        </NavLink>
                        <NavLink to="/admin/departments" className="p-6 rounded-[2rem] bg-base-200/50 hover:bg-white hover:shadow-xl hover:shadow-secondary/5 transition-all border border-base-300/50 flex items-center gap-6 group/item active:scale-95">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-base-content/40 font-bold uppercase tracking-widest">Departments</p>
                            </div>
                        </NavLink>
                    </div>
                </div>
    ...
    return (
        <div className="space-y-10 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-base-100 rounded-2xl border border-base-300 shadow-sm">
                    <div className="w-2 h-2 rounded-full bg-success animate-pulse"></div>
                    <span className="text-[10px] font-black uppercase tracking-widest text-base-content/60">Faculty Session Live</span>
                </div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Total Courses */}
                <div className="relative group overflow-hidden bg-base-100 border border-base-300 rounded-[2.5rem] p-10 transition-all hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/10">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-base-content/40 mb-2">Curriculum Load</p>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-bold text-base-content/60 uppercase">Courses Assigned</span>
                    </div>
                </div>

                {/* Total Students */}
                <div className="relative group overflow-hidden bg-base-100 border border-base-300 rounded-[2.5rem] p-10 transition-all hover:border-secondary/50 hover:shadow-2xl hover:shadow-secondary/10">
                    <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-all group-hover:scale-110">
                        <HiOutlineUserGroup size={100} className="text-secondary" />
                    </div>
                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-base-content/40 mb-2">Student Reach</p>
                    ...
                    <div className="text-[10px] font-bold text-base-content/40 uppercase tracking-widest">Across All Sections</div>
                </div>
            </div>
                ...
                <div className="lg:col-span-2 bg-base-100 border border-base-300 rounded-[3rem] p-10 relative overflow-hidden group">
                    ...
                    <div className="flex items-center justify-between mb-10">
                        <div>
                            ...
                            <p className="text-xs font-medium text-base-content/40 uppercase tracking-widest">Professional Credentials</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                        <div className="bg-base-200/50 p-6 rounded-[2rem] border border-base-300/50">
                            <span className="text-[10px] font-black text-base-content/30 uppercase tracking-[0.3em] block mb-2">Designation</span>
                            <p className="text-xl font-black text-primary tracking-tight">{stats.designation}</p>
                        </div>
                        <div className="bg-base-200/50 p-6 rounded-[2rem] border border-base-300/50">
                            <span className="text-[10px] font-black text-base-content/30 uppercase tracking-[0.3em] block mb-2">Department</span>
                            <p className="text-xl font-black text-base-content/80 tracking-tight">{stats.department}</p>
                        </div>
                        <div className="bg-base-200/50 p-6 rounded-[2rem] border border-base-300/50">
                            <span className="text-[10px] font-black text-base-content/30 uppercase tracking-[0.3em] block mb-2">Office Hours</span>
                            <p className="text-lg font-bold text-secondary">Mon-Fri (2:00PM - 4:00PM)</p>
                        </div>
                        <div className="bg-base-200/50 p-6 rounded-[2rem] border border-base-300/50 flex items-center justify-between">
                            <div>
                                <span className="text-[10px] font-black text-base-content/30 uppercase tracking-[0.3em] block mb-1">Status</span>
                ...
                <div className="bg-neutral rounded-[3rem] p-10 text-neutral-content shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-3 mb-8">
                        <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center">
                            <HiOutlineChartBar size={20} className="text-white/40" />
                        </div>
                        <h4 className="text-xl font-black italic">Upcoming<br/>Research</h4>
                    </div>
                    
                    <div>
                        <p className="text-white/40 text-[10px] font-black tracking-widest uppercase mb-4">SYMPOSIUM DEADLINE</p>
                        <p className="text-white/70 text-sm font-medium leading-relaxed">
                            Submit your research proposals for the Annual Academic Symposium by June 20th.
                        </p>
                    </div>

                    <button className="btn btn-outline border-white/10 hover:bg-white hover:text-neutral text-white mt-10 rounded-2xl w-full font-black tracking-widest text-[10px] uppercase transition-all active:scale-95">
                        View Details
                    </button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <NavLink to="/faculty/courses" className="p-6 rounded-[2rem] bg-base-100 border border-base-300/50 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5 transition-all flex items-center gap-6 group">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-base-content/40 font-bold uppercase tracking-widest">Management</p>
                    </div>
                </NavLink>
                <NavLink to="/faculty/profile" className="p-6 rounded-[2rem] bg-base-100 border border-base-300/50 hover:border-secondary/30 hover:shadow-xl hover:shadow-secondary/5 transition-all flex items-center gap-6 group">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-base-content/40 font-bold uppercase tracking-widest">Update Profile</p>
                    </div>
                </NavLink>
            </div>
        </div>
    ...
    return (
        <div className="space-y-10 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-base-100 rounded-2xl border border-base-300 shadow-sm">
                    <div className="w-2 h-2 rounded-full bg-success animate-pulse"></div>
                    <span className="text-[10px] font-black uppercase tracking-widest text-base-content/60">Session Active</span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="relative group overflow-hidden bg-base-100 border border-base-300 rounded-[2.5rem] p-8 transition-all hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/10">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest text-base-content/40 mb-1">Cumulative Grade</p>
                    <h3 className="text-5xl font-black text-primary tracking-tighter mb-2 group-hover:scale-105 transition-transform origin-left">
                        {stats.cgpa.toFixed(2)}
                    </h3>
                    <div className="flex items-center gap-2">
                        <span className="badge badge-primary badge-sm font-black italic">TOP 10%</span>
                        <span className="text-[10px] font-bold text-base-content/60 uppercase">CGPA Status</span>
                    </div>
                </div>
                ...
                <div className="relative group overflow-hidden bg-base-100 border border-base-300 rounded-[2.5rem] p-8 transition-all hover:border-secondary/50 hover:shadow-2xl hover:shadow-secondary/10">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest text-base-content/40 mb-1">Credits Earned</p>
                    <h3 className="text-5xl font-black text-secondary tracking-tighter mb-2 group-hover:scale-105 transition-transform origin-left">
                ...
                <div className="relative group overflow-hidden bg-base-100 border border-base-300 rounded-[2.5rem] p-8 transition-all hover:border-accent/50 hover:shadow-2xl hover:shadow-accent/10">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest text-base-content/40 mb-1">Enrolled Items</p>
                    <h3 className="text-5xl font-black text-accent tracking-tighter mb-2 group-hover:scale-105 transition-transform origin-left">
                ...
                {/* Profile Link Card */}
                <div className="bg-primary rounded-[2.5rem] p-8 text-primary-content shadow-xl shadow-primary/30 flex flex-col justify-between relative overflow-hidden group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-base-100 border border-base-300 rounded-[3rem] p-10 relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-primary via-secondary to-accent"></div>
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            <h4 className="text-2xl font-black text-base-content tracking-tighter">Academic Status</h4>
                            <p className="text-xs font-medium text-base-content/40 uppercase tracking-widest">Official Record Details</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-6">
                            <div className="bg-base-200/50 p-6 rounded-[2rem] border border-base-300/50">
                                <span className="text-[10px] font-black text-base-content/30 uppercase tracking-[0.3em] block mb-2">University ID</span>
                        ...
                        <div className="flex flex-col justify-center space-y-4">
                            <div className="flex items-center gap-4 group">
                                <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center text-primary transition-transform group-hover:rotate-12">
                                    <HiOutlinePencilAlt size={24} />
                                </div>
                                <div>
                                    <p className="text-xs font-black uppercase tracking-wider text-base-content/70">Quick Action</p>
                                    <NavLink to="/student/enrollment" className="text-sm font-bold text-primary hover:underline">Register for Courses</NavLink>
                                </div>
                            </div>
                            <div className="flex items-center gap-4 group">
                                <div className="w-12 h-12 rounded-2xl bg-secondary/10 flex items-center justify-center text-secondary transition-transform group-hover:rotate-12">
                                    <HiOutlineStar size={24} />
                                </div>
                                <div>
                                    <p className="text-xs font-black uppercase tracking-wider text-base-content/70">My Progress</p>
